...
var Accounts = require("./data-business");

var ClientsAccounts = require("./account-business");
...
function getClientElement(client) {
  ...
  var ul = ClientsAccounts.getClientAccountsElement(clientAccounts);
  node.appendChild(ul);
  return node;
}
...
var Clients = require("./data-business");

var ClientsElement = require("./client-business");
...
function printClientsAccounts() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var element = ClientsElement.getClientElement(client);
...
var ClientsAccounts = require("./client-list-business");

window.onload = function () {
  ClientsAccounts.printClientsAccounts();
};
},{"./client-list-business":"src/client-list-business.js"}],"C:/Users/Manudous/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "15440" + '/');
